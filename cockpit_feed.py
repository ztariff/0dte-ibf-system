...
STRATEGIES = [
    {"ver":"v3","name":"PHOENIX","regime":"PHOENIX","entry":"10:00","mech":"50%/close/1T","filter":None,
     "desc":"PHOENIX — Concentrated Signal Model","color":"#f59e0b",
     "vix":None,"pd":None,"rng":None,"gap":None},
    {"ver":"v6","name":"QUIET REBOUND","regime":"LOW_DN_IN_GFL","entry":"10:00","mech":"50%/1530/1T","filter":"VP<=1.7",
     "desc":"QUIET REBOUND — Low VIX | Prior Day Down | In Range | Flat Gap","color":"#06b6d4",
